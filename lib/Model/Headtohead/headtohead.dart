...
List<HeadtoHead> headtoheadFromJson(String str) => List<HeadtoHead>.from(json.decode(str).map((x) => HeadtoHead.fromJson(x)));

String headtoheadToJson(List<HeadtoHead> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
