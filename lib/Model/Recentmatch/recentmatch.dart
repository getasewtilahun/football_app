...
List<RecentMatch> recentMatchFromJson(String str) => List<RecentMatch>.from(json.decode(str).map((x) => RecentMatch.fromJson(x)));

String recentMatchToJson(List<RecentMatch> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
